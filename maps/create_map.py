...
if __name__ == "__main__" :
    ...
    Button1 = Button(app, text="Save", font=("Helvetica", "12"), command=pressed)
    Button2 = Button(app, text="Load", font=("Helvetica", "12"), command=load_state)
    Button3 = Button(app, text="Load 1", font=("Helvetica", "12"),  command=load_state_1)
    Button4 = Button(app, text="Load 2", font=("Helvetica", "12"),  command=load_state_2)
    # Button4 = Button(app, text="Map2", command=load_buffer_stochastic_edges)
    Percentage = Label(text="", fg="Red", font=("Helvetica", "12"))
    Button1.pack()
    Button2.pack()
    Button3.pack()
    Button4.pack()
